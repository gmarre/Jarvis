...
- Quel(s) fichier(s) doivent être mis à jour : `jarvis-starter-kit/CLAUDE.md`, `jarvis-starter-kit/context/CONTEXT.md`, `jarvis-starter-kit/context/HISTORY.md`
...
2. Ajoute une entrée datée dans `jarvis-starter-kit/context/HISTORY.md` sous le format suivant :
...
- Garde CONTEXT.md synthétique, si une section devient trop longue, propose de créer un fichier dédié dans `jarvis-starter-kit/context/import/`
