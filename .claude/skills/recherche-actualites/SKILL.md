...
1. `jarvis-starter-kit/context/CONTEXT.md` (qui il est, ce qu'il fait, ses objectifs, ses projets)
2. `jarvis-starter-kit/context/HISTORY.md` (les sessions récentes pour comprendre les sujets actifs)
...
Note : il vaut mieux présenter 3 actualités vraiment pertinentes que 10 actualités génériques.
